# Errors
Errors assigned to trivechain servers responses.<br>
...
### Installation
```
$ npm install triveasset-errors
```
### Creating error messages
First, `require` the module like so:
```javascript
require('triveasset-errors')
```
...
```javascript
var errorhandler = require('triveasset-errors').errorHandler()
```
