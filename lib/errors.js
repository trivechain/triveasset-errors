...
// Trivechain base error (all errors will inherit from it)
errors.create({
  name: 'TrivechainError'
})
...
errors.create = function (options) {
  ...
  options.parent = options.parent || errors.TrivechainError
...
errors.create({
  name: 'TATransactionConstructionError',
  code: 20000,
